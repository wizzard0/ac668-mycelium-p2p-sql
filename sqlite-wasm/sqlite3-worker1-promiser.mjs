...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
  worker: function () {
    ...
    if(url1.indexOf('blob:')!==-1){
      url1 = url1.replace('blob:','');
      url1 = new URL('/lib/sqlite-wasm/', url1);
    }
    console.log('sqlite3Worker1Promiser.defaultConfig.worker');
    console.log('import.meta.url', import.meta.url, url1,new URL('sqlite3-worker1-bundler-friendly.mjs', url1));
    return new Worker(
      new URL('sqlite3-worker1-bundler-friendly.mjs', url1),
      {
        type: 'module',
      },
    );
